...
- **Virtual schemas** — `information_schema` (PostgreSQL-compatible tables/columns/schemata views) and `system` (providers, functions, per-column statistics) queryable via standard SQL with `schema.table` syntax
