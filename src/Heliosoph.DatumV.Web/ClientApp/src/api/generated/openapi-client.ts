...
export class DatasetCatalogClient {
    ...
    getRecipeSql(path: string, signal?: AbortSignal): Promise<string> {
        let url_ = this.baseUrl + "/api/dataset-catalog/recipes/{path}";
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGetRecipeSql(_response);
        });
    }

    protected processGetRecipeSql(response: Response): Promise<string> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
...
export class FilesClient {
    ...
    getRoot(signal?: AbortSignal): Promise<CatalogRootDto> {
        let url_ = this.baseUrl + "/api/files/root";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processGetRoot(response: Response): Promise<CatalogRootDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
            let result200: any = null;
            result200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver) as CatalogRootDto;
            return result200;
            });
        } else if (status !== 200 && status !== 204) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<CatalogRootDto>(null as any);
    }

    getContents(path: string | undefined, signal?: AbortSignal): Promise<FileContentsDto> {
        let url_ = this.baseUrl + "/api/files/contents?";
        if (path === null)
    ...
    protected processGetContents(response: Response): Promise<FileContentsDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
            let result200: any = null;
            result200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver) as FileContentsDto;
            return result200;
            });
        } else if (status !== 200 && status !== 204) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<FileContentsDto>(null as any);
    }

    putContents(path: string | undefined, body: FileContentsRequestDto, signal?: AbortSignal): Promise<FileContentsResponseDto> {
        let url_ = this.baseUrl + "/api/files/contents?";
        if (path === null)
            throw new globalThis.Error("The parameter 'path' cannot be null.");
        else if (path !== undefined)
    ...
    protected processPutContents(response: Response): Promise<FileContentsResponseDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
            let result200: any = null;
            result200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver) as FileContentsResponseDto;
            return result200;
            });
        } else if (status !== 200 && status !== 204) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<FileContentsResponseDto>(null as any);
    }

    deleteContents(path: string | undefined, signal?: AbortSignal): Promise<FileResponse> {
        let url_ = this.baseUrl + "/api/files/contents?";
        if (path === null)
            throw new globalThis.Error("The parameter 'path' cannot be null.");
        else if (path !== undefined)
    ...
    protected processDeleteContents(response: Response): Promise<FileResponse> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200 || status === 206) {
            const contentDisposition = response.headers ? response.headers.get("content-disposition") : undefined;
    ...
    renameFile(body: FileRenameRequestDto, signal?: AbortSignal): Promise<FileResponse> {
        let url_ = this.baseUrl + "/api/files/rename";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processRenameFile(response: Response): Promise<FileResponse> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200 || status === 206) {
            const contentDisposition = response.headers ? response.headers.get("content-disposition") : undefined;
    ...
    getTabsState(signal?: AbortSignal): Promise<string> {
        let url_ = this.baseUrl + "/api/files/state/tabs";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGetTabsState(_response);
        });
    }

    protected processGetTabsState(response: Response): Promise<string> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    putTabsState(body: any, signal?: AbortSignal): Promise<FileResponse> {
        let url_ = this.baseUrl + "/api/files/state/tabs";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processPutTabsState(_response);
        });
    }

    protected processPutTabsState(response: Response): Promise<FileResponse> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200 || status === 206) {
            const contentDisposition = response.headers ? response.headers.get("content-disposition") : undefined;
...
export class GpuClient {
    ...
    getStatus(signal?: AbortSignal): Promise<GpuStatusDto> {
        let url_ = this.baseUrl + "/api/gpu/status";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processGetStatus(response: Response): Promise<GpuStatusDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
            let result200: any = null;
            result200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver) as GpuStatusDto;
            return result200;
            });
        } else if (status !== 200 && status !== 204) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<GpuStatusDto>(null as any);
    }

    startInstall(signal?: AbortSignal): Promise<FileResponse> {
        let url_ = this.baseUrl + "/api/gpu/install";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processStartInstall(_response);
        });
    }

    protected processStartInstall(response: Response): Promise<FileResponse> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200 || status === 206) {
            const contentDisposition = response.headers ? response.headers.get("content-disposition") : undefined;
    ...
    cancelInstall(signal?: AbortSignal): Promise<FileResponse> {
        let url_ = this.baseUrl + "/api/gpu/install/cancel";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processCancelInstall(_response);
        });
    }

    protected processCancelInstall(response: Response): Promise<FileResponse> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200 || status === 206) {
            const contentDisposition = response.headers ? response.headers.get("content-disposition") : undefined;
    ...
    uninstall(version: string, signal?: AbortSignal): Promise<FileResponse> {
        let url_ = this.baseUrl + "/api/gpu/installed/{version}";
...
export interface CatalogRootDto {
    catalogRoot?: string;
}
...
export interface FileContentsResponseDto {
    modifiedAt?: Date;
}

export interface FileContentsRequestDto {
    contents?: string;
}
...
export interface GpuStatusDto {
    ...
    availableEntry?: CudaBundlePlatformEntryDto | undefined;
    updateAvailable?: boolean;
    isInstalling?: boolean;
    activeInstallVersion?: string | undefined;
}

export interface CudaBundlePlatformEntryDto {
    url?: string;
    sha256?: string;
    sizeBytes?: number;
