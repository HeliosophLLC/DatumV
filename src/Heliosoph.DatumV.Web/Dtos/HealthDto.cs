namespace Heliosoph.DatumV.Web.Dtos;
...
public sealed record HealthDto(
    ...
    // ModelCatalog after the settings.json override > $DATUMV_MODELS env
    // var > %LOCALAPPDATA%/Heliosoph.DatumV/models cascade. Null when the host
    ...
    // from the WebHostOptions override > $DATUMV_DATASETS env var >
    // %LOCALAPPDATA%/Heliosoph.DatumV/datasets-cache cascade. Null when no
