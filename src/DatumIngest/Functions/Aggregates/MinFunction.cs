...
/// </summary>
public sealed class MinFunction : IAggregateFunction, IAggregateFunctionMetadata
{
    ...
    public static string Description =>
        "Minimum non-null value in a group; works on any comparable kind (numeric, string, date, datetime, time).";
