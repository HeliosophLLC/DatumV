...
/// <summary>
/// Returns the largest non-null argument. Nulls are skipped; if every
/// argument is null the result is null. Matches PostgreSQL's <c>GREATEST()</c>.
/// </summary>
/// <remarks>
...
/// </remarks>
public sealed class GreatestFunction : IFunction, IScalarFunction
{
    /// <inheritdoc />
    public static string Name => "greatest";
    ...
    public static string Description =>
        "Returns the largest of the given arguments. Null arguments are skipped; " +
    ...
    public DataKind ValidateArguments(ReadOnlySpan<DataKind> argumentKinds) =>
        FunctionMetadata.Validate<GreatestFunction>(argumentKinds);
    ...
    public ValueTask<ValueRef> ExecuteAsync(
        ...
        new(MinMaxComparison.Execute(arguments.Span, pickSmaller: false));
}
