...
/// <summary>
/// Returns the first argument verbatim when it is strictly less than the
/// threshold; throws otherwise. Null in either operand passes through
/// unchecked.
/// </summary>
public sealed class AssertLessThanFunction : IFunction, IScalarFunction
{
    /// <inheritdoc />
    public static string Name => "assert_less_than";
    ...
    public static string Description =>
        "Returns the input value when it is strictly less than the threshold; throws otherwise. " +
    ...
    public DataKind ValidateArguments(ReadOnlySpan<DataKind> argumentKinds) =>
        FunctionMetadata.Validate<AssertLessThanFunction>(argumentKinds);
        ...
        CancellationToken cancellationToken)
    {
        ...
        AssertHelpers.Throw(
            ...
            $"value {AssertHelpers.Display(value)} was not less than {AssertHelpers.Display(threshold)}");
        return default;
    }
