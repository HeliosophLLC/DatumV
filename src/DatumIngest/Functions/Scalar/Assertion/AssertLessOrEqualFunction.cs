...
/// <summary>
/// Returns the first argument verbatim when it is less than or equal to the
/// threshold; throws otherwise. Null in either operand passes through
/// unchecked.
/// </summary>
public sealed class AssertLessOrEqualFunction : IFunction, IScalarFunction
{
    /// <inheritdoc />
    public static string Name => "assert_less_or_equal";
    ...
    public static string Description =>
        "Returns the input value when it is less than or equal to the threshold; throws otherwise. " +
    ...
    public DataKind ValidateArguments(ReadOnlySpan<DataKind> argumentKinds) =>
        FunctionMetadata.Validate<AssertLessOrEqualFunction>(argumentKinds);
        ...
        CancellationToken cancellationToken)
    {
        ...
        AssertHelpers.Throw(
            ...
            $"value {AssertHelpers.Display(value)} was not less than or equal to {AssertHelpers.Display(threshold)}");
        return default;
    }
