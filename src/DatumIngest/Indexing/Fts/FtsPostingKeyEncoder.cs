...
/// the dup-key <see cref="DatumIngest.Indexing.BTree.MutableBytes.MutableBPlusTreeBytes"/>
/// behind <see cref="FullTextSearchIndex"/>. Posting tie-breakers (chunk,
/// rowOff) live on <see cref="DatumIngest.Indexing.BTree.MutableBytes.BytesIndexEntry"/>
...
/// <see cref="DatumIngest.Indexing.CompositeKeyEncoder"/> uses for strings.
...
///
/// <para>The escape logic mirrors <see cref="DatumIngest.Indexing.CompositeKeyEncoder"/>;
