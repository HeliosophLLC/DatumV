...
public static class Ingester
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        // 1. Detect format → create IFormatDeserializer
        // 2. Create deserializer Arena + serializer Arena
        // 3. Deserialize → SchemaDetector → StatisticsCollector + SampleCollector → DatumSerializer
