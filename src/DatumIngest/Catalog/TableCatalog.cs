...
public sealed class TableCatalog : IDisposable, IEnumerable<ITableProvider>
{
    ...
    /// </summary>
    internal static void ValidateIdentitySpecForColumn(
    ...
    /// </summary>
    internal static void ValidateDefaultExpression(Expression expression, string columnName)
    {
    ...
    /// </summary>
    internal async Task ValidateDefaultExpressionFitsColumnAsync(
