...
public static class SqlTokenizer
{
    ...
    public static Tokenizer<SqlToken> Instance { get; } =
        new TokenizerBuilder<SqlToken>()
            ...
            .Match(Span.EqualToIgnoreCase("JSONVALUE"), SqlToken.TypeKeyword, requireDelimiters: true)
            .Match(Span.EqualToIgnoreCase("VECTOR"), SqlToken.TypeKeyword, requireDelimiters: true)
            .Match(Span.EqualToIgnoreCase("MATRIX"), SqlToken.TypeKeyword, requireDelimiters: true)
            .Match(Span.EqualToIgnoreCase("TENSOR"), SqlToken.TypeKeyword, requireDelimiters: true)
            .Match(Span.EqualToIgnoreCase("UINT8ARRAY"), SqlToken.TypeKeyword, requireDelimiters: true)
            .Match(Span.EqualToIgnoreCase("IMAGE"), SqlToken.TypeKeyword, requireDelimiters: true)
            .Match(Span.EqualToIgnoreCase("ARRAY"), SqlToken.TypeKeyword, requireDelimiters: true)
