...
/// leading substring composed entirely of characters drawn from
/// <c>characters</c> (default: a single space). Null input propagates to null
/// output.
/// </summary>
public sealed class LtrimFunction : IFunction, IScalarFunction
{
    /// <inheritdoc />
    ...
    public DataKind ValidateArguments(ReadOnlySpan<DataKind> argumentKinds) =>
        FunctionMetadata.Validate<LtrimFunction>(argumentKinds);
        ...
        CancellationToken cancellationToken)
    {
        ...
        ReadOnlySpan<char> trimmed = input.AsString().AsSpan().TrimStart(chars);
