...
public sealed class FunctionRegistry
{
    ...
    public static FunctionRegistry CreateDefault()
    {
        ...
        registry.RegisterScalar<Scalar.Arrays.ArrayFlattenFunction>();
        ...
        registry.RegisterScalar<Scalar.Image.ImageBrightnessStdFunction>();
        registry.RegisterScalar<Scalar.Image.ImageBrightnessHistogramFunction>();
        registry.RegisterScalar<Scalar.Image.DetectBlurFunction>();
        registry.RegisterScalar<Scalar.Image.CompressionArtifactScoreFunction>();
        registry.RegisterScalar<Scalar.Image.ImagePixelMeanFunction>();
        registry.RegisterScalar<Scalar.Image.ImagePixelStdFunction>();
        ...
        registry.RegisterScalar<Scalar.Image.SobelImageFunction>();
        registry.RegisterScalar<Scalar.Image.NoiseImageFunction>();
        registry.RegisterScalar<Scalar.Image.ResizeAndCropImageFunction>();
        registry.RegisterScalar<Scalar.Image.AffineTransformFunction>();
        registry.RegisterScalar<Scalar.Image.ElasticDeformFunction>();
        registry.RegisterScalar<Scalar.Image.PerspectiveWarpFunction>();
        registry.RegisterScalar<Scalar.Image.DirectionalWarpFunction>();
        registry.RegisterScalar<Scalar.Image.PerceptualHashFunction>();
        registry.RegisterScalar<Scalar.Image.ImageChannelsFunction>();
        ...
        registry.RegisterScalar<Scalar.Spatial.PcVoxelConsensusFunction>();
