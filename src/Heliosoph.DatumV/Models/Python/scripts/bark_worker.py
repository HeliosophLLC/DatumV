...
# the engine via DATUMV_MODELS when it spawns this worker. Loading
...
MODEL_DIR = os.environ.get("DATUMV_MODELS")
if not MODEL_DIR:
    print("[bark] DATUMV_MODELS not set; the engine should always "
