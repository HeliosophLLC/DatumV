...
public sealed class InMemoryTableProvider : ITableProvider
{
    ...
    private static object? ConvertDataValueToCell(DataValue value, Arena arena, SidecarRegistry? registry)
    {
        ...
        return value.Kind switch
        {
            ...
            DataKind.Int128 => value.AsInt128(),
            DataKind.UInt128 => value.AsUInt128(),
            ...
            DataKind.Timestamp => value.AsTimestamp(),
    ...
    private static DataValue MaterializeCell(object? cell, DataKind expectedKind, Arena arena)
    {
        ...
        return cell switch
        {
            ...
            Int128 i128 => DataValue.FromInt128(i128),
            UInt128 u128 => DataValue.FromUInt128(u128),
            ...
            // DateTimeOffset → TimestampTz (PG timestamptz): UTC-normalised
            DateTimeOffset dto => DataValue.FromTimestampTz(dto),
            // DateTime → Timestamp (PG timestamp without tz): naive ticks
    ...
    private static DataKind InferKindFromClrType(object value) => value switch
    {
        ...
        DateTimeOffset => DataKind.TimestampTz,
