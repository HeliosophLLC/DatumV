...
/// <item><c>Family</c> — coarse HuggingFace-style grouping (NaturalLanguageProcessing /
    /// ComputerVision / Audio / Multimodal / Tabular)
...
public static class TaskTypeRegistry
{
    ...
    public enum TaskFamily
    {
        ...
        /// <summary>Image- and video-in contracts (classification, detection, segmentation, depth, 3D, restoration, …).</summary>
        ComputerVision,
    ...
    [
        // ─── text ───────────────────────────────────────────────────────
        new("TextEmbedder", TaskFamily.NaturalLanguageProcessing,
            [Scalar(DataKind.String)],
            ArrayOf(DataKind.Float32),
            "Text → vector embedding. L2-normalized by convention."),
        new("TextClassifier", TaskFamily.NaturalLanguageProcessing,
            [Scalar(DataKind.String)],
            Named("ScoredClass"),
            "Text → single class with confidence."),
        new("LabeledTextClassifier", TaskFamily.NaturalLanguageProcessing,
            [Scalar(DataKind.String)],
            Named("ScoredLabel"),
        ...
        new("TextMultiClassifier", TaskFamily.NaturalLanguageProcessing,
            [Scalar(DataKind.String)],
            ArrayOfNamed("ScoredClass"),
            "Text → multiple classes with confidence (multi-label)."),
        new("LabeledTextMultiClassifier", TaskFamily.NaturalLanguageProcessing,
            [Scalar(DataKind.String)],
        ...
        new("BinaryTextClassifier", TaskFamily.NaturalLanguageProcessing,
            [Scalar(DataKind.String)],
            Named("BinaryScore"),
            "Text → boolean classification with confidence (spam/toxicity/polarity)."),
        new("TokenClassifier", TaskFamily.NaturalLanguageProcessing,
            [Scalar(DataKind.String)],
            ArrayOfNamed("ScoredToken"),
            "Text → per-token labels (NER, POS tagging)."),
        new("TextPairScorer", TaskFamily.NaturalLanguageProcessing,
        ...
        new("TextReranker", TaskFamily.NaturalLanguageProcessing,
            [Scalar(DataKind.String), ArrayOf(DataKind.String)],
            ArrayOfNamed("ScoredIndex"),
            "Query + candidate texts → reranked indices with scores."),
        new("TextGenerator", TaskFamily.NaturalLanguageProcessing,
            [Scalar(DataKind.String)],
            Scalar(DataKind.String),
            "Text → text. LLM completion."),
        new("ChatCompleter", TaskFamily.NaturalLanguageProcessing,
        ...
        new("Translator", TaskFamily.NaturalLanguageProcessing,
            [Scalar(DataKind.String)],
            Scalar(DataKind.String),
            "Text → translated text."),
        new("TextSummarizer", TaskFamily.NaturalLanguageProcessing,
            [Scalar(DataKind.String)],
            Scalar(DataKind.String),
            "Text → summary."),
        new("TextEditor", TaskFamily.NaturalLanguageProcessing,
            [Scalar(DataKind.String), Scalar(DataKind.String)],
            Scalar(DataKind.String),
            "Text + instruction → edited text (instruction-tuned LLM)."),

        // ─── image: classification + embedding + tagging ────────────────
        new("ImageClassifier", TaskFamily.ComputerVision,
            [Scalar(DataKind.Image)],
            Named("ScoredClass"),
            "Image → single class with confidence."),
        new("LabeledImageClassifier", TaskFamily.ComputerVision,
            [Scalar(DataKind.Image)],
            Named("ScoredLabel"),
        ...
        new("ImageMultiClassifier", TaskFamily.ComputerVision,
            [Scalar(DataKind.Image)],
            ArrayOfNamed("ScoredClass"),
            "Image → multiple classes with confidence (multi-label / top-k)."),
        new("BinaryImageClassifier", TaskFamily.ComputerVision,
            [Scalar(DataKind.Image)],
            Named("BinaryScore"),
            "Image → boolean classification (NSFW / defect / pass-fail)."),
        new("ImageTagger", TaskFamily.ComputerVision,
            [Scalar(DataKind.Image)],
            ArrayOfNamed("ScoredLabel"),
            "Image → open-vocabulary tags with scores."),
        new("ImageEmbedder", TaskFamily.ComputerVision,
            [Scalar(DataKind.Image)],
            ArrayOf(DataKind.Float32),
            "Image → vector embedding. L2-normalized by convention."),
        new("ImageCaptioner", TaskFamily.ComputerVision,
            [Scalar(DataKind.Image)],
            Scalar(DataKind.String),
            "Image → descriptive caption."),

        // ─── image: detection + segmentation ────────────────────────────
        new("ObjectDetector", TaskFamily.ComputerVision,
            [Scalar(DataKind.Image)],
            ArrayOfNamed("ScoredDetection"),
            "Image → bounding boxes with classes + confidences."),
        new("LabeledObjectDetector", TaskFamily.ComputerVision,
            [Scalar(DataKind.Image)],
        ...
        new("StereoDepthEstimator", TaskFamily.ComputerVision,
        ...
        new("MeshFromImage", TaskFamily.ComputerVision,
            [Scalar(DataKind.Image)],
        ...
        new("ImageUpscaler", TaskFamily.ComputerVision,
            [Scalar(DataKind.Image)],
            Scalar(DataKind.Image),
            "Image → higher-resolution Image (super-resolution)."),
        new("ImageRestorer", TaskFamily.ComputerVision,
            [Scalar(DataKind.Image)],
            Scalar(DataKind.Image),
            "Image → restored Image (denoise / dehaze / deblur)."),
        new("ImageColorizer", TaskFamily.ComputerVision,
            [Scalar(DataKind.Image)],
            Scalar(DataKind.Image),
            "Grayscale Image → colorized Image."),
        new("ImageStyleTransfer", TaskFamily.ComputerVision,
            [Scalar(DataKind.Image), Scalar(DataKind.Image)],
            Scalar(DataKind.Image),
            "Content image + style image → stylized image."),
        new("ImageEditor", TaskFamily.ComputerVision,
        ...
        // ─── tabular (tabular / time series) ────────────────────────────
        new("TabularClassifier", TaskFamily.Tabular,
            [ArrayOf(DataKind.Float32)],
            Named("ScoredClass"),
            "Feature vector → single class with confidence."),
        new("TabularRegressor", TaskFamily.Tabular,
            [ArrayOf(DataKind.Float32)],
            Scalar(DataKind.Float32),
            "Feature vector → continuous prediction."),
        new("TimeSeriesClassifier", TaskFamily.Tabular,
            [ArrayOf(DataKind.Float32)],
            Named("ScoredClass"),
            "Time series → single class with confidence."),
        new("TimeSeriesForecaster", TaskFamily.Tabular,
            [ArrayOf(DataKind.Float32)],
            ArrayOf(DataKind.Float32),
            "Time series → forecasted values."),
        new("TimeSeriesAnomalyDetector", TaskFamily.Tabular,
            [ArrayOf(DataKind.Float32)],
            Scalar(DataKind.Float32),
