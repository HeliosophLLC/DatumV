...
public sealed class ImageTransformFunctionExtendedTests
{
    ...
    public void Brighten_Validate_AcceptsCorrectArgs()
    {
        Assert.Equal(DataKind.Image,
            _brighten.ValidateArguments([DataKind.Image, DataKind.Scalar]));
    }
    ...
    {
        Assert.Equal(DataKind.Image,
            _brighten.ValidateArguments([DataKind.Image, DataKind.Scalar, DataKind.String]));
    }
    ...
    public void Brighten_ReturnsImage()
    {
        ...
        DataValue result = _brighten.Execute(
            [DataValue.FromImage(png), DataValue.FromScalar(50f)]);
    ...
    {
        DataValue result = _brighten.Execute(
            [DataValue.Null(DataKind.Image), DataValue.FromScalar(50f)]);
    ...
    {
        Assert.Equal(DataKind.Image,
            _darken.ValidateArguments([DataKind.Image, DataKind.Scalar]));
    }
    ...
    {
        Assert.Equal(DataKind.Image,
            _darken.ValidateArguments([DataKind.Image, DataKind.Scalar, DataKind.String]));
    }
    ...
    public void ResizeAndCrop_Validate_AcceptsCorrectArgs()
    {
        Assert.Equal(DataKind.Image,
            _resizeAndCrop.ValidateArguments(
                [DataKind.Image, DataKind.Scalar, DataKind.Scalar, DataKind.String]));
    }
    ...
    public void ResizeAndCrop_Validate_AcceptsOptionalFormat()
    {
        Assert.Equal(DataKind.Image,
            _resizeAndCrop.ValidateArguments(
                [DataKind.Image, DataKind.Scalar, DataKind.Scalar, DataKind.String, DataKind.String]));
    }
    ...
    public void ResizeAndCrop_Validate_WrongArgCount_Throws()
    {
        Assert.Throws<ArgumentException>(() =>
            _resizeAndCrop.ValidateArguments([DataKind.Image, DataKind.Scalar]));
    }
    ...
    public void ResizeAndCrop_CenterGravity_ProducesExactDimensions()
    {
        ...
        DataValue result = _resizeAndCrop.Execute(
            [DataValue.FromImage(png), DataValue.FromScalar(50f), DataValue.FromScalar(50f),
    ...
    public void ResizeAndCrop_TopGravity_ProducesExactDimensions()
    {
        byte[] png = MakeTestPng(100, 80);
        DataValue result = _resizeAndCrop.Execute(
            [DataValue.FromImage(png), DataValue.FromScalar(40f), DataValue.FromScalar(40f),
    ...
    public void ResizeAndCrop_NullInput_ReturnsNull()
    {
        DataValue result = _resizeAndCrop.Execute(
            [DataValue.Null(DataKind.Image), DataValue.FromScalar(50f),
             DataValue.FromScalar(50f), DataValue.FromString("center")]);
        Assert.True(result.IsNull);
    }
    ...
    public void AffineTransform_Validate_AcceptsOptionalFormat()
    {
        Assert.Equal(DataKind.Image,
            _affineTransform.ValidateArguments(
                [DataKind.Image, DataKind.Scalar, DataKind.Scalar,
                 DataKind.Scalar, DataKind.Scalar, DataKind.Scalar, DataKind.String]));
    }
    ...
    {
        Assert.Throws<ArgumentException>(() =>
            _affineTransform.ValidateArguments([DataKind.Image, DataKind.Scalar]));
    }
    ...
    public void AffineTransform_IdentityTransform_PreservesSize()
    {
        ...
        DataValue result = _affineTransform.Execute(
            [DataValue.FromImage(png), DataValue.FromScalar(0f),
             DataValue.FromScalar(1f), DataValue.FromScalar(1f),
             DataValue.FromScalar(0f), DataValue.FromScalar(0f)]);
    ...
    {
        DataValue result = _affineTransform.Execute(
            [DataValue.Null(DataKind.Image), DataValue.FromScalar(0f),
             DataValue.FromScalar(1f), DataValue.FromScalar(1f),
             DataValue.FromScalar(0f), DataValue.FromScalar(0f)]);
        Assert.True(result.IsNull);
    }
    ...
    public void ElasticDeform_PreservesSize()
    {
        ...
        DataValue result = _elasticDeform.Execute(
            [DataValue.FromImage(png), DataValue.FromScalar(10f), DataValue.FromScalar(3f)]);
    ...
    {
        DataValue result = _elasticDeform.Execute(
            [DataValue.Null(DataKind.Image), DataValue.FromScalar(10f), DataValue.FromScalar(3f)]);
        Assert.True(result.IsNull);
    }
    ...
    {
        Assert.Equal(DataKind.Image,
            _perspectiveWarp.ValidateArguments([DataKind.Image, DataKind.Scalar]));
    }
    ...
    public void PerspectiveWarp_Validate_AcceptsIntensityModeWithFormat()
    {
        Assert.Equal(DataKind.Image,
            _perspectiveWarp.ValidateArguments(
                [DataKind.Image, DataKind.Scalar, DataKind.String]));
    }
    ...
    {
        DataKind[] nineArgs =
            [DataKind.Image, DataKind.Scalar, DataKind.Scalar, DataKind.Scalar,
    ...
    public void PerspectiveWarp_IntensityMode_PreservesSize()
    {
        ...
        DataValue result = _perspectiveWarp.Execute(
            [DataValue.FromImage(png), DataValue.FromScalar(0.1f)]);
    ...
    public void PerspectiveWarp_ExplicitCorners_PreservesSize()
    {
        ...
        DataValue result = _perspectiveWarp.Execute(
            [DataValue.FromImage(png),
             DataValue.FromScalar(0f), DataValue.FromScalar(0f),     // top-left
             DataValue.FromScalar(1f), DataValue.FromScalar(0f),     // top-right
             DataValue.FromScalar(0f), DataValue.FromScalar(1f),     // bottom-left
             DataValue.FromScalar(1f), DataValue.FromScalar(1f)]);   // bottom-right
    ...
    {
        DataValue result = _perspectiveWarp.Execute(
            [DataValue.Null(DataKind.Image), DataValue.FromScalar(0.1f)]);
        Assert.True(result.IsNull);
    }
}
