...
public class JsonTypeInferenceTests
{
    ...
    public void InferKind_Number_ReturnsScalar()
    {
        ...
        Assert.Equal(DataKind.Scalar, JsonTypeInference.InferKind(element));
    }
    ...
    {
        Assert.Equal(DataKind.Scalar, JsonTypeInference.WidenKind(DataKind.Scalar, DataKind.Scalar));
    ...
    {
        Assert.Equal(DataKind.String, JsonTypeInference.WidenKind(DataKind.Scalar, DataKind.String));
        Assert.Equal(DataKind.String, JsonTypeInference.WidenKind(DataKind.Date, DataKind.Scalar));
    ...
    public void WidenKind_JsonValue_DominatesOtherKinds()
    {
        ...
        Assert.Equal(DataKind.JsonValue, JsonTypeInference.WidenKind(DataKind.Scalar, DataKind.JsonValue));
