...
public sealed class PredicateValueRefPathTests
{
    ...
    [Fact]
    public void Equal_FunctionCallVsLiteral_ReturnsTrue()
    {
        // upper('alice') = 'ALICE'
        Expression predicate = Bin(
            ...
            Lit("ALICE"));
        Assert.True(_evaluator.EvaluateAsBoolean(predicate, Frame));
    }

    [Fact]
    public void Equal_FunctionCallVsLiteral_ReturnsFalse()
    {
        Expression predicate = Bin(
            Call("upper", Lit("alice")),
            BinaryOperator.Equal,
            Lit("BOB"));
        Assert.False(_evaluator.EvaluateAsBoolean(predicate, Frame));
    }

    [Fact]
    public void NotEqual_FunctionCall_ReturnsTrue()
    {
        Expression predicate = Bin(
            Call("upper", Lit("alice")),
    ...
    [Fact]
    public void Equal_NestedFunctionChain_ReturnsTrue()
    {
    ...
    [Fact]
    public void Equal_ConcatVsLiteral_ReturnsTrue()
    {
    ...
    [Fact]
    public void Like_FunctionResult_Matches()
    {
        // upper('alice') LIKE 'AL%'
        Expression predicate = Bin(
            Call("upper", Lit("alice")),
    ...
    [Fact]
    public void Like_DoesNotMatch_ReturnsFalse()
    {
        Expression predicate = Bin(
            Call("upper", Lit("alice")),
            BinaryOperator.Like,
    ...
    [Fact]
    public void ILike_CaseInsensitiveMatch_ReturnsTrue()
    {
        Expression predicate = Bin(
            Call("upper", Lit("alice")),
    ...
    [Fact]
    public void Regexp_FunctionResult_Matches()
    {
        Expression predicate = Bin(
            Call("upper", Lit("alice")),
    ...
    [Fact]
    public void And_BothFunctionPredicates_True()
    {
    ...
    [Fact]
    public void And_OneFalse_ShortCircuitsToFalse()
    {
        Expression predicate = Bin(
    ...
    [Fact]
    public void Not_FunctionPredicate_Inverts()
    {
    ...
    [Fact]
    public void IsNull_FunctionResult_NotNull_ReturnsFalse()
    {
    ...
    [Fact]
    public void IsNotNull_FunctionResult_NotNull_ReturnsTrue()
    {
        Expression predicate = new IsNullExpression(
            Call("upper", Lit("alice")),
            Negated: true);
    ...
    [Fact]
    public void IsNull_NullLiteral_ReturnsTrue()
    {
    ...
    [Fact]
    public void Arithmetic_FunctionInComparison_ReturnsTrue()
    {
    ...
    [Fact]
    public void Arithmetic_AddInComparison_ReturnsTrue()
    {
        // 10 + 5 > 12
        Expression predicate = Bin(
    ...
    [Fact]
    public void Equal_NullOperand_ReturnsFalse()
    {
