...
Single variant (~1.4 GB, CPU-runnable). This is the **recommended metric
default** unless the scene is strictly indoor or driving-style outdoor,
where the specialist [ZoeDepth](../zoedepth-nyu-kitti/index.md) heads
still edge it out.
