...
Toolchain: `optimum 1.24.0`, `diffusers 0.31.0`, `transformers 4.45.2`, `torch 2.4.x` (CUDA 12.4). Conversion script: [`scripts/export-mo-di-hyper.ps1`](https://github.com/HeliosophLLC/Heliosoph/blob/main/scripts/export-mo-di-hyper.ps1).
