-- ============================================================================
-- SCUNet (Blind Real-World Color, GAN) — Apache-2.0.
-- ============================================================================
--
-- Catalog id:  scunet-color-real-gan           (models/catalog.json)
...
-- plausible texture (hair, fabric) the noisy input couldn't pin down.
-- Pick for consumer photo cleanup; avoid when fidelity matters.
--
...
CREATE OR REPLACE MODEL scunet_color_real_gan(
  img      Image,
  max_side Int32 = 1024
