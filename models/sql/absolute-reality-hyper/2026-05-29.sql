-- ============================================================================
-- AbsoluteReality + Hyper-SD — text-to-image, CreativeML OpenRAIL-M.
-- ============================================================================
--
-- Catalog id:  absolute-reality-hyper          (models/catalog.json)
-- ONNX files:  text_encoder/model.onnx, unet/model.onnx, vae_decoder/model.onnx
-- License:     CreativeML OpenRAIL-M
-- Upstream:    https://huggingface.co/Lykon/absolute-reality + ByteDance/Hyper-SD
--
-- Photoreal-leaning SD 1.5 general-purpose workhorse distilled to 4 steps.
-- Pipeline shape is identical to every other SD 1.x Hyper variant — see
-- models/sql/realistic-vision-hyper/2026-05-29.sql for the canonical
-- annotated reference; this file differs only in the model name and the
-- USING paths.
-- ============================================================================

CREATE OR REPLACE MODEL absolute_reality_hyper(
  prompt String,
  steps  Int32 = 4
...
USING 'absolute-reality-hyper/text_encoder/model.onnx' AS text_encoder,
