-- ============================================================================
-- Openjourney + Hyper-SD — text-to-image, CreativeML OpenRAIL-M.
-- ============================================================================
--
-- Catalog id:  openjourney-hyper               (models/catalog.json)
-- License:     CreativeML OpenRAIL-M
-- Upstream:    https://huggingface.co/prompthero/openjourney + ByteDance/Hyper-SD
--
-- Midjourney-v4-style SD 1.5 fine-tune distilled to 4 steps. Activator
-- phrase: 'mdjrny-v4 style'. Pipeline shape is identical to every other
-- SD 1.x Hyper variant; see
...
USING 'openjourney-hyper/text_encoder/model.onnx' AS text_encoder,
