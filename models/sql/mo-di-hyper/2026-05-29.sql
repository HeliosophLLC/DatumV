-- ============================================================================
-- Mo-Di Diffusion + Hyper-SD — text-to-image, CreativeML OpenRAIL-M.
-- ============================================================================
--
-- Catalog id:  mo-di-hyper                     (models/catalog.json)
-- License:     CreativeML OpenRAIL-M
-- Upstream:    https://huggingface.co/nitrosocke/mo-di-diffusion + ByteDance/Hyper-SD
--
-- Modern Disney / Pixar style SD 1.5 fine-tune distilled to 4 steps.
-- Activator phrase: 'modern disney style'. Pipeline shape is identical to
-- every other SD 1.x Hyper variant; see
-- models/sql/realistic-vision-hyper/2026-05-29.sql for the canonical
-- annotated reference.
-- ============================================================================

CREATE OR REPLACE MODEL mo_di_hyper(
  prompt String,
  steps  Int32 = 4
