-- ============================================================================
-- SCUNet Color (σ=25) — Apache-2.0.
-- ============================================================================
--
-- Catalog id:  scunet-color-25                 (models/catalog.json)
...
-- level. Use for σ≈25 matched conditions or for apples-to-apples
-- comparison with other published denoisers at σ=25.
--
...
CREATE OR REPLACE MODEL scunet_color_25(
  img      Image,
  max_side Int32 = 1024
...
USING 'scunet-color-25/2026-05-29/scunet_color_25.onnx'
AS BEGIN
