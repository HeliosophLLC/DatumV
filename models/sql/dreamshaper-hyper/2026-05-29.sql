-- ============================================================================
-- DreamShaper + Hyper-SD — text-to-image, CreativeML OpenRAIL-M.
-- ============================================================================
--
-- Catalog id:  dreamshaper-hyper               (models/catalog.json)
-- License:     CreativeML OpenRAIL-M
-- Upstream:    https://huggingface.co/Lykon/dreamshaper-8 + ByteDance/Hyper-SD
--
-- Stylized SD 1.5 fine-tune — fantasy / painterly / illustrative — distilled
-- to 4 steps. Pipeline shape is identical to every other SD 1.x Hyper
-- variant; see models/sql/realistic-vision-hyper/2026-05-29.sql for the
-- canonical annotated reference.
-- ============================================================================

CREATE OR REPLACE MODEL dreamshaper_hyper(
  prompt String,
  steps  Int32 = 4
...
USING 'dreamshaper-hyper/text_encoder/model.onnx' AS text_encoder,
