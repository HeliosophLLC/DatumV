-- ============================================================================
-- Metric3D V2 Giant (fp16) — metric depth + surface normals, BSD-2-Clause.
-- ============================================================================
--
-- Catalog id:  metric3d-v2-giant-fp16          (models/catalog.json)
-- ONNX files:  onnx/model_fp16.onnx + onnx/model_fp16.onnx_data
-- License:     BSD-2-Clause
-- Upstream:    https://github.com/YvanYin/Metric3D
--              (onnx-community fp16 ONNX export of Metric3D V2 ViT-Giant)
--
-- Half-precision sibling of `metric3d_v2_giant`. ~2.7 GB on disk vs
-- ~5.5 GB for fp32. Same outputs; pick when container size or VRAM
-- footprint matters more than negligible numerical precision.
--
